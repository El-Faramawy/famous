            ...
            <div class="m-portlet__head">
                <div class="m-portlet__head-caption">
                    <div class="m-portlet__head-title">
                        <h3 class="m-portlet__head-text" style="font-family: Cairo">
                            مشرفين صيت المشاهير
                        </h3>
                    </div>
                </div>
...
{{--                        @if($user->id != admin()->user()->id)--}}
                        <tr>
                            ...
                            <td>{{$user->email}}</td>
                            <td>{{$user->phone}}</td>
                            <td><img style="width: 50px;height: 50px;border-radius: 50%" src="{{asset($user->image)}} " alt="user" onclick="window.open(this.src)"/></td>
                            <td >
