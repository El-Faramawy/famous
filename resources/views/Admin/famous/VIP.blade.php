...
<div class="card mb-5 mb-xl-8 mt-10">
    ...
    <div class="card-header border-0 pt-5">
        ...
        <div class="card-toolbar">
            ...
            <a href="" class="btn btn-light-danger er fs-6 px-7 py-3" data-bs-toggle="modal" data-bs-target="#Deactivate_all">
...
{{--                        </div>--}}
                        <div>
                            ...
                            <span class="count mr-3"> من : ( {{$famous->visitors}} ) زائر </span>
                        </div>
                    </td>

                    <td>{{$famous->created_at}}</td>


                        <td class="">
                        <button class="btn btn-light-danger btn-sm" style="font-size: 14px !important;" data-id='{{$famous->id}}' data-famous_name='{{$famous->name}}' data-bs-toggle='modal' data-bs-target="#deactivate_famous" >
                            الغاء عضوية VIP
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-3 mx-xl-15 my-3">
                <!--begin::Form-->
                <form id="kt_modal_new_card_form" class="form" action="{{route('deactivate_all_famous')}}" method="post">
                    <!--begin::Input group-->
                    {{csrf_field()}}
...
<div class="modal fade" id="deactivate_famous" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-3 mx-xl-15 my-3">
                <!--begin::Form-->
                <form id="kt_modal_new_card_form" class="form" action="{{route('deactivate_one_famous')}}" method="post">
                    {{csrf_field()}}
