                        ...
                        <tr>
                            <td>
								...
								<span class="symbol-label bg-light">
                                    ...
                                    <div class="d-flex justify-content-start text-left flex-column">
                                        <a href=""
                                           class="text-dark fw-bolder text-hover-primary mb-1 fs-5">{{$famous->name}} @if($famous->is_favorite == 'yes')<i class="fa fa-medal" style="color: #FFD700"></i>@endif</a>
                                        <span
                            ...
                            <td class="">
                                <button class="btn btn-sm btn-light btn-active-light-primary"
                                        data-id='{{$famous->id}}' data-status='{{$famous->status}}'
                                        data-image='{{asset($famous->image)}}'
                                    ...
                                    الحالة <i class="fa fa-edit"></i>
                                </button>
                                @if($famous->package->count() > 0)
                                    <button class="btn btn-sm btn-light btn-active-light-success"
                                            data-bs-toggle='modal' title="" data-bs-target="#famous_package"
                                            data-id='{{$famous->id}}'
                                        ...
                                        @endfor
                                    >
                                        الباقات <i class="fa fa-gifts"></i>
                                    </button>
                                @endif
                                <button data-id="{{$famous->id}}" data-famous_name="{{$famous->name}}"
                                        data-bs-target="#delete_famous" title="حذف"
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-3 mx-xl-15 my-3">
                    <!--begin::Form-->
                    <form id="kt_modal_new_card_form" class="form" action="{{route('delete_all_famous')}}"
                          method="post">
                        <!--begin::Input group-->
                        {{csrf_field()}}
    ...
    <div class="modal fade" id="delete_famous" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-3 mx-xl-15 my-3">
                    <!--begin::Form-->
                    <form id="kt_modal_new_card_form" class="form" action="{{route('delete_one_famous')}}"
                          method="post">
                        {{csrf_field()}}
        ...
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header" style="padding: 10px">
                    <!--begin::Modal title-->
                    <h4>بيانات المشهور <i class="fa fa-star"></i></h4>
                    <!--end::Modal title-->
                    <!--begin::Close-->
                    <div class="btn btn-sm btn-icon btn-active-color-primary" data-bs-dismiss="modal">
                        <!--begin::Svg Icon | path: icons/duotone/Navigation/Close.svg-->
                ...
                <form action="{{route('edit_famous')}}" method="post">
                    {{csrf_field()}}
                    <div class="modal-body scroll-y" style="padding: 10px">
                        ...
                        <div class="card mb-5 mb-xl-1">
                            ...
                            <div class="card-body pt-5">
                                ...
                                <div class="d-flex flex-center flex-column">
                                    ...
                                    <!--end::Avatar-->
                                    <!--begin::Name-->
                                    <p href="" class="fs-3 text-gray-800 fw-bolder mb-1"
                                       id="famous_name"></p>
                                    <!--end::Name-->
                                    <!--begin::Position-->
                                    <div class="fs-5 fw-bold text-gray-400 mb-1" id="job"></div>
                                    <!--end::Position-->
                                    <!--begin::Info-->
                                    <!--begin::Details item-->
                                    <!--end::Info-->
                                ...
                                <div class="row">
                                    <!--begin::Details item-->
                                    <div class="col-6 fw-bolder mt-2">
                                    ...
                                    <!--begin::Details item-->
                                    <div class="col-6 fw-bolder mt-2">الحالة
                                        <br>
                                        <select name="status" id="status" class="form-select form-select-solid">
                                            <option value="accepted" id="accepted">مقبول</option>
                                            <option value="refused" id="refused">مرفوض</option>
                                        </select>
                                    </div>
                                    <!--begin::Details item-->
                                </div>
                                ...
                                <div class="d-flex flex-stack fs-4 py-3">
                                    <div class="fw-bolder rotate collapsible" data-bs-toggle="collapse"
                                         ...
                                         aria-controls="kt_customer_view_details">تفاصيل
                                ...
                                <div id="kt_customer_view_details" class="collapse show">
                                    <div class="py-2 fs-6">
                                        ...
                                        <div class="text-center mt-3">
                                            <a class="bi bi-facebook col-2 fs-2" id="facebook"
                                               style="color: #292929"></a>
                                            <a class="bi bi-instagram col-2 fs-2" id="instagram"
                                               style="color: #292929"></a>
...
<script>
    $(document).ready(function () {
        ...
        $('#edit_famous').on('show.bs.modal', function (event) {
            ...
            modal.find('.modal-body #id').val(id);
            modal.find('.modal-body #new').show();
            modal.find('.modal-body #accepted').show();
            modal.find('.modal-body #refused').show();
            modal.find('.modal-body #new').prop("disabled", false);
            modal.find('.modal-body #accepted').prop("disabled", false);
            modal.find('.modal-body #refused').prop("disabled", false);
