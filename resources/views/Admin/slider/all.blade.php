            ...
            <div class="modal-body scroll-y mx-3 mx-xl-15 my-3">
                ...
                <form id="kt_modal_new_card_form" class="form" action="{{route('delete_all_sliders')}}" method="post">
                    ...
                    <div class="d-flex flex-column mb-3 fv-row">
                        <!--begin::Label-->
                            <h4>سيتم حذف جميع بيانات المعرض ! هل تريد المتابعة</h4>
                        <!--end::Label-->
                    </div>
                    <!--end::Input group-->
            ...
            <div class="modal-body scroll-y mx-3 mx-xl-15 my-3">
                ...
                <form id="kt_modal_new_card_form" class="form" action="{{route('delete_slider')}}" method="post">
                    ...
                    <div class="d-flex flex-column mb-7 fv-row fv-plugins-icon-container">
                        ...
                        <input type="text" disabled class="form-control form-control-solid fs-2" placeholder="" name="slider_title" id="slider_title" value="">
...
<!-------------------------start EDIT Form -------------------------------------------------------------->
<div class="modal fade show" id="edit_slider" tabindex="-1" aria-modal="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <!--begin::Modal content-->
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-1">
                <!--begin::Form-->
                <form method="post" id="kt_modal_new_card_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" action="{{route('update_slider')}}" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <input type="hidden" id="id" name="id">
                    <div class="fv-row mb-5">
                        <!--begin::Label-->
                        <label class="d-block fw-bold fs-6 mb-3">تغيير صورة المعرض</label>
                        <!--end::Label-->
                        <!--begin::Image input-->
                        <div class="row">
                    ...
                    <div class="d-flex flex-column mb-7 fv-row fv-plugins-icon-container">
                        ...
                        <!--end::Label-->
                        <input type="text" class="form-control form-control-solid mb-4" placeholder="اكتب جملة قصيرة" name="slider_title"  id="slider_title" value="" autocomplete="off">
                        <!--end::Input group-->
                        <!--begin::Input group-->
                        <div class="d-flex flex-column mb-7 fv-row fv-plugins-icon-container">
                            <!--begin::Label-->
                            ...
                            <div class="position-relative">
                                <!--begin::Input-->
                                <input type="text" class="form-control form-control-solid" placeholder="اضف شرح او وصف خاص" name="slider_content"  id="slider_content" value="" autocomplete="off">
                                <!--end::Input-->
                            </div>
                            <!--end::Input wrapper-->
                            <div class="fv-plugins-message-container invalid-feedback"></div></div>
                        ...
                        <div class="row mb-1">
                            ...
                            <div class="col-md-6 fv-row fv-plugins-icon-container">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" class="form-control form-control-solid" placeholder="مثال : المشاهير" name="slider_btn" id='slider_btn' autocomplete="off">
                                <!--end::Input-->
                                <div class="fv-plugins-message-container invalid-feedback"></div></div>
                            <!--end::Col-->
                            <!--begin::Col-->
                            <div class="col-md-6 fv-row fv-plugins-icon-container">
                                ...
                                <!--end::Label-->
                                <!--end::Input-->
                                <input type="text" class="form-control form-control-solid" placeholder="ادخل لينك رابط كامل" name="slider_btn_link" id="slider_btn_link" autocomplete="off">
                                <!--end::Input-->
                                <div class="fv-plugins-message-container invalid-feedback"></div></div>
                            <!--end::Col-->
                        </div>                        <!--end::Input group-->
