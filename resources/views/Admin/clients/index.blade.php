                        ...
                        <div class="d-flex align-items-center">
                            <div class="symbol symbol-50px me-5">
								<span class="symbol-label bg-light">
									<img class="h-75" onclick="window.open(this.src)" style='cursor: pointer' src={{asset('/uploads/clients/'.$client->image)}}  alt="">
								</span>
                            </div>
                            <div class="d-flex justify-content-start flex-column">
                                <a href="" class="text-dark fw-bolder text-hover-primary mb-1 fs-5">{{$client->name}}</a>
{{--                                <span class="text-muted fw-bold text-muted d-block fs-6">{{$client->job->title}}</span>--}}
                    ...
                    <td><a href="{{$client->company_email}}" class="bi bi-link"></a> {{$client->company_email}}</td>

                    <td>{{$client->phone}}</td>

                    <td class="">
                        <button class="btn btn-icon btn-bg-light btn-primary btn-sm me-1" title="تفاصيل" data-bs-toggle="modal" data-bs-target="#client_info" style="border-radius: 50% !important"
                                data-image='{{asset('/uploads/clients/'.$client->image)}}' data-client_name='{{$client->name}}'
                                data-date='{{$client->created_at}}' data-tax_num='{{$client->tax_num}}'
                                data-phone ='{{$client->phone}}'
                                data-trad_num='{{$client->id}}' data-id_num='{{$client->id_num}}'
                                data-company_name='{{$client->company_name}}'  data-company_email='{{$client->company_email}}'
                        >
                        ...
                        <button data-id="{{$client->id}}" data-client_name="{{$client->name}}" data-bs-target="#delete_client" title="حذف" class="btn btn-icon btn-bg-light btn-danger btn-sm me-1" data-bs-toggle="modal" style="border-radius: 50% !important">
                                <span class="svg-icon svg-icon-3">
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-3 mx-xl-15 my-3">
                <!--begin::Form-->
                <form id="kt_modal_new_card_form" class="form" action="{{route('delete_all_clients')}}" method="post">
                    <!--begin::Input group-->
                    {{csrf_field()}}
...
<div class="modal fade" id="delete_client" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-3 mx-xl-15 my-3">
                <!--begin::Form-->
                <form id="kt_modal_new_card_form" class="form" action="{{route('delete_one_client')}}" method="post">
                    {{csrf_field()}}
                    ...
                    <div class="d-flex flex-column mb-7 fv-row fv-plugins-icon-container">
                        ...
                        <input type="text" disabled class="form-control form-control-solid fs-2" placeholder="" name="client_name" id="client_name" value="">
                    ...
                    <div class="card mb-5 mb-xl-8">
                        ...
                        <div class="card-body pt-15">
                            ...
                            <div class="d-flex flex-center flex-column mb-5">
                                ...
                                <!--end::Avatar-->
                                <!--begin::Name-->
                                <a href="" class="fs-3 text-gray-800 text-hover-primary fw-bolder mb-1" id="client_name"></a>
                                <!--end::Name-->
                                <!--begin::Position-->
                            ...
                            <div class="d-flex flex-stack fs-4 py-3">
                                <div class="fw-bolder rotate collapsible" data-bs-toggle="collapse" href="#kt_customer_view_details" role="button" aria-expanded="false" aria-controls="kt_customer_view_details">باقي التفاصيل
                            ...
                            <div id="kt_customer_view_details" class="collapse show">
                                <div class="py-5 fs-6">
                                    ...
                                    <div class="text-gray-600">
                                        <a href="" class="text-gray-600 text-hover-primary" id="company_email"></a>
                                    </div>
                                    <!--begin::Details item-->
                                    <!--begin::Details item-->
