        ...
        <div class="table-responsive">
            ...
            <table id="kt_datatable_example_5" class="table align-middle gs-0 gy-4">
                ...
                @foreach($Prev_ads as $famous)
                    ...
                    <td>
                       <a href="{{$famous->email}}"> <span class="menu-icon"><i class="bi bi-youtube fs-2"></i></span></a>
                    </td>
...
{{--                <!--begin::Table body-->--}}
{{--                <tbody>--}}
{{--                 @foreach( $Prev_ads as $refused_ad)--}}
